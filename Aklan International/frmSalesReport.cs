...
namespace Aklan_International
{
    ...
    {
        private static frmSalesReport instance;



        public static frmSalesReport getInstance()
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new frmSalesReport();
            }
            return instance;
        }
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                xlWorkBook.SaveAs("dtsales.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                //xlWorkBook.Open();
                ...
                MessageBox.Show("Excel file created , you can find the file at Documents/dtsales.xls");
                xlApp.Visible = true;
                //xlApp.Quit();
